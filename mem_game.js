...
var images = ['pair1', 'pair2', 'pair3', 'pair4', 'pair5', 'pair6', 'pair7', 'pair8', 'pair9', 'pair10', 'pair11', 'pair12'];
var desiredCount = 0;
var shuffledPairs = [];
...
function setup(shuffledPairs){
  ...
  var arr = ['card', `card${i+1}`, shuffledPairs[i]]
	...
	if(len == 12){
		board.style.cssText = "width: calc(120px*4 + 20px*3 ); height: calc(120px*3 + 20px*3); display: grid; grid-gap: 20px; grid-template-columns: repeat(4, 1fr); grid-template-rows: repeat(3, 1fr);";
	}
	else if(len==16){
		board.style.cssText = "width: calc(120px*4 + 20px*3 ); height: calc(120px*4 + 20px*4); display: grid; grid-gap: 20px; grid-template-columns: repeat(4, 1fr); grid-template-rows: repeat(4, 1fr);";
	}
	else if(len==24){
		board.style.cssText = "width: calc(120px*6 + 20px*5 ); height: calc(120px*4 + 20px*4); display: grid; grid-gap: 20px; grid-template-columns: repeat(6, 1fr); grid-template-rows: repeat(3, 1fr);";
	}
